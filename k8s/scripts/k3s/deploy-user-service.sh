...
# deploy-user-service.sh - Deploy user-service to k3s cluster
# Usage: ./deploy-user-service.sh [version]
# If version is not provided, extracts version from user-service/pom.xml

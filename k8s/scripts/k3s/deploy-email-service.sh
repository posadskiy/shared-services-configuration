...
# deploy-email-service.sh - Deploy email-service to k3s cluster
# Usage: ./deploy-email-service.sh [version]
# If version is not provided, extracts version from email-service/pom.xml

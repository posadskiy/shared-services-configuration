...
# deploy-email-template-service.sh - Deploy email-template-service to k3s cluster
# Usage: ./deploy-email-template-service.sh [version]
# If version is not provided, extracts version from email-template-service/pom.xml

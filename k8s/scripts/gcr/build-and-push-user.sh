...
docker buildx build --platform linux/amd64 -f user-service/Dockerfile.prod -t $REGISTRY/user-service:$VERSION -t $REGISTRY/user-service:$TAG_DATE user-service/ --push
